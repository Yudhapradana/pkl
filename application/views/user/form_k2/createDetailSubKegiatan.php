          ...
          <div class="card-body">
            <form action="<?php base_url('user/rkask2/createDetailSubKegiatan/'). $this->uri->segment(4) ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="satuan" value="" required>
                <div class="invalid-feedback">Masukkan satuan</div>
              </div>
              <div class="form-group">
                <label for="hargaSatuan">Harga Satuan</label>
                <input type="number" class="form-control" name="harga_satuan" value="" required>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="nominalBos" value="0" required>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="nominalBantuan" value="0" required>
                <div class="invalid-feedback">Masukkan Nominal</div>
              </div>
              <div class="form-group">
