      ...
      <div class="col-md-4">
        <div class="card card-profile">
          <div class="card-body">
            ...
            <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#k1">Cek Laporan</a>
...
<!-- Modal k1-->
<div class="modal fade" id="k1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Melihat Laporan Form BOS-K1</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="<?php echo base_url().'Laporan/exportk1/'.$this->session->id_sekolah ?>" method='post' target="_blank">
          <div class="form-group">
            <label for="" class="label">Tahun: </label>
            <input type="number" name="tahun" class="form-control" min="2017" value="2017" autofocus required>
          </div>
