              ...
              <tbody>
                <?php foreach ($sekolah as $key => $value): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url('admin/rkask1/penerimaan/') . $value->id_sekolah ?>" rel="tooltip" title="Penerimaan" class="btn btn-sm btn-info">
                        <i class="material-icons">toggle_off</i>
                      </a>
                      <a href="<?php echo base_url('admin/rkask1/pengeluaran/') . $value->id_sekolah ?>" rel="tooltip" title="Pengeluaran" class="btn btn-sm btn-info">
