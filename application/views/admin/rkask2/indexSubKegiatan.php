                ...
                <tbody>
                  <?php foreach ($subkegiatan as $key => $value): ?>
                    <tr>
                      ...
                      <td>
                      <a href="<?php echo base_url('admin/rkask2/detailSubkegiatan/'.$this->uri->segment(4).'/') .$value->id_sub_kegiatan_k2 ?>" rel="tooltip" title="Detail Sub Kegiatan K2" class="btn btn-sm btn-info">
